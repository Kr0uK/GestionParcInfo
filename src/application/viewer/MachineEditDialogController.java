...
public class MachineEditDialogController {
    ...
    private void handleOk() {
        ...
        if (isInputValid()) {
           // daoMachine.modifier(machine, LectureRB.lireRB("query","lectureMachines"),String.valueOf(machine.getId()));
         //   machine.setIdSP(txtfld1.getText());
           // machine.setId(Integer.parseInt(txtfld1.getText()));
            ...
            daoMachine.ajouter(machine,LectureRB.lireRB("query","lectureMachines"));
            okClic = true;
            dialogStage.close();
